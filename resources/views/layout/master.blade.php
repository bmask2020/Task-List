...
<body class="container mx-auto mt-10 max-w-lg font-serif">
    ...
    <div style="margin:0 1rem" x-data="{ flash: true }">

        @if (session()->has('success'))

        <div x-show="flash" class="relative mb-10 rounded border border-green-400 bg-green-100 py-3 px-4 text-lg text-green-700" role="alert">
